...
app.put('/:directorio/:id/:nuevonombre', (req, res, next) => {


    var id = req.params.id;
    var nombrenuevoarchivo = req.params.nuevonombre;
    var directorio = req.params.directorio;
    var body = req.body;
    console.log('cuerpo', nombrenuevoarchivo);
    console.log('id', id);
  ...
  //  nombreArchivo = `${nombreCortado[0]}.${extensionArchivo}`;
    nombreArchivo = `${nombrenuevoarchivo}.${extensionArchivo}`;
